...
class SignUp extends React.Component {
  ...
  handleUsernameChange = (event) => {
    ...
    this.timeout = setTimeout(
      function () {
        fetch(config.serverURL + "userExists/" + event.target.value)
    ...
    return (
      <div className="container">
        ...
        >
          <div id="form-body">
            <input
              className={this.checkError("username") ? "error" : ""}
              type="text"
              name="username"
            ...
            <input
              className={
                this.checkError("emailExists") ||
                this.checkError("emailInvalid")
                  ? "error"
                  : ""
              }
              type="text"
            ...
            <br />
            <input
              className={this.checkError("passwordLength") ? "error" : ""}
              type="password"
              name="password"
            ...
            <br />
            <input
              className={this.checkError("passwordMatch") ? "error" : ""}
              type="password"
              name="password-confirm"
              placeholder="Confirm password"
              onChange={(e) => {
                this.handlePasswordConfirmChange(e);
              }}
            />
            <input type="submit" className="hidden" />
            <div
              className={
                "errorBox" + (this.checkError("username") ? "" : " hidden")
              }
            >
            ...
            <div
              className={
                "errorBox" + (this.checkError("emailExists") ? "" : " hidden")
              }
            >
            ...
            <div
              className={
                "errorBox" +
                (this.checkError("passwordLength") ? "" : " hidden")
              }
            >
            ...
            <div
              className={
                "errorBox" + (this.checkError("passwordMatch") ? "" : " hidden")
              }
            >
